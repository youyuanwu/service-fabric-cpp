// note : boost log put after will cause link error.
...
#include <servicefabric/asio_callback.h>
#include <servicefabric/compose.h>
...
int main(){
    ...
    std::function<void(boost::system::error_code, IFabricGetNodeListResult*)> node_callback =
        [](boost::system::error_code ec, IFabricGetNodeListResult* result){
    ...
    std::function<void(boost::system::error_code ec, IFabricGetApplicationTypeListResult* result)> app_callback =
    [](boost::system::error_code ec, IFabricGetApplicationTypeListResult* result){
