...
namespace Common {
template <class TRootedObject> class RootedObjectPointer {
public:
  ...
  RootedObjectPointer(RootedObjectPointer const &other) throw()
      : p_(other.p_), root_(other.root_) {}

  RootedObjectPointer(RootedObjectPointer &&other) throw()
      : p_(other.p_), root_(std::move(other.root_)) {
    other.p_ = NULL;
  }
  ...
  TRootedObject *operator->() const throw() { return p_; }

  RootedObjectPointer const &
  operator=(RootedObjectPointer const &other) throw() {
    if (p_ != other.p_) {
      p_ = other.p_;
      root_ = other.root_;
    }
