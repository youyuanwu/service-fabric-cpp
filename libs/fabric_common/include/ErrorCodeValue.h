...
// Without casting FABRIC_E_ error codes to int, Clang will use consider them
// unsigned, and since E_INVALIDARG etc are HRESULT which is LONG, the size of
// Enum will become 8 bytes, which will be different from the Windows side.
enum Enum : int {
  // Public ErrorCodes
  Success = S_OK,
  ...
  UserRoleClientCertificateNotConfigured =
      (int)FABRIC_E_USER_ROLE_CLIENT_CERTIFICATE_NOT_CONFIGURED,
  HostingServiceTypeAlreadyRegistered =
      (int)FABRIC_E_SERVICE_TYPE_ALREADY_REGISTERED,
  ...
  REInvalidEpoch =
      E_INVALIDARG, // do we need to round trip this through HRESULT?
  ReconfigurationPending = (int)FABRIC_E_RECONFIGURATION_PENDING,
  REQueueFull = (int)FABRIC_E_REPLICATION_QUEUE_FULL,
  REReplicaAlreadyExists =
      (int)FABRIC_E_INVALID_OPERATION, // do we need to round trip this through
                                       // HRESULT?
  ...
  ServiceAffinityChainNotSupported =
      (int)FABRIC_E_SERVICE_AFFINITY_CHAIN_NOT_SUPPORTED,
  ...
  ApplicationTypeProvisionInProgress =
      (int)FABRIC_E_APPLICATION_TYPE_PROVISION_IN_PROGRESS,
  ...
  ApplicationAlreadyInTargetVersion =
      (int)FABRIC_E_APPLICATION_ALREADY_IN_TARGET_VERSION,
  ApplicationUpgradeValidationError =
      (int)FABRIC_E_APPLICATION_UPGRADE_VALIDATION_ERROR,
  ...
  ConfigurationParameterNotFound =
      (int)FABRIC_E_CONFIGURATION_PARAMETER_NOT_FOUND,
  ...
  CorruptedImageStoreObjectFound =
      (int)FABRIC_E_CORRUPTED_IMAGE_STORE_OBJECT_FOUND,
  ...
  UpgradeDomainAlreadyCompleted =
      (int)FABRIC_E_UPGRADE_DOMAIN_ALREADY_COMPLETED,
  ...
  ReliableSessionTransportStartupFailure =
      (int)FABRIC_E_RELIABLE_SESSION_TRANSPORT_STARTUP_FAILURE,
  ...
  ReliableSessionServiceFaulted =
      (int)FABRIC_E_RELIABLE_SESSION_SERVICE_FAULTED,
  ReliableSessionManagerAlreadyListening =
      (int)FABRIC_E_RELIABLE_SESSION_MANAGER_ALREADY_LISTENING,
  ReliableSessionManagerNotFound =
      (int)FABRIC_E_RELIABLE_SESSION_MANAGER_NOT_FOUND,
  ReliableSessionManagerNotListening =
      (int)FABRIC_E_RELIABLE_SESSION_MANAGER_NOT_LISTENING,
  ReliableSessionInvalidTargetPartition =
      (int)FABRIC_E_RELIABLE_SESSION_INVALID_TARGET_PARTITION,
  ...
  VerboseFMPlacementHealthReportingRequired =
      (int)FABRIC_E_VERBOSE_FM_PLACEMENT_HEALTH_REPORTING_REQUIRED,
  ...
  MultithreadedTransactionsNotAllowed =
      (int)FABRIC_E_MULTITHREADED_TRANSACTIONS_NOT_ALLOWED,
  ...
  DuplicateServiceNotificationName =
      (int)FABRIC_E_DUPLICATE_SERVICE_NOTIFICATION_FILTER_NAME,
  ...
  ForceNotSupportedForReplicaOperation =
      (int)FABRIC_E_FORCE_NOT_SUPPORTED_FOR_REPLICA_OPERATION,
  ...
  TestCommandOperationIdAlreadyExists =
      (int)FABRIC_E_TEST_COMMAND_OPERATION_ID_ALREADY_EXISTS,

  /// <summary>
  /// Creation or deletion terminated due to persistent failures after bounded
  /// retry.
  /// </summary>
  CMOperationFailed = (int)FABRIC_E_CM_OPERATION_FAILED,

  ImageBuilderReservedDirectoryError =
      (int)FABRIC_E_IMAGEBUILDER_RESERVED_DIRECTORY_ERROR,
  ...
  UploadSessionRangeNotSatisfiable =
      (int)FABRIC_E_UPLOAD_SESSION_RANGE_NOT_SATISFIABLE,
  ...
  OnlyValidForStatefulPersistentServices =
      (int)FABRIC_E_ONLY_VALID_FOR_STATEFUL_PERSISTENT_SERVICES,

  ContainerNotFound = (int)FABRIC_E_CONTAINER_NOT_FOUND,

  CentralSecretServiceGenericError =
      (int)FABRIC_E_CENTRAL_SECRET_SERVICE_GENERIC,
  ...
  RestoreSourceTargetPartitionMismatch =
      (int)FABRIC_E_RESTORE_SOURCE_TARGET_PARTITION_MISMATCH,
  FaultAnalysisServiceNotEnabled =
      (int)FABRIC_E_FAULT_ANALYSIS_SERVICE_NOT_ENABLED,
  ...
  SingleInstanceApplicationAlreadyExists =
      (int)FABRIC_E_SINGLE_INSTANCE_APPLICATION_ALREADY_EXISTS,
  SingleInstanceApplicationNotFound =
      (int)FABRIC_E_SINGLE_INSTANCE_APPLICATION_NOT_FOUND,
  SingleInstanceApplicationUpgradeInProgress =
      (int)FABRIC_E_SINGLE_INSTANCE_APPLICATION_UPGRADE_IN_PROGRESS,
  ...
  // Internal ErrorCodes
  //
  // By starting internal error codes at the end of our reserved range minus
  // count, ErrorCodeValues remain consistent and do not cause gaps in the
  // public error code range.
  //
  // This requires keeping this count in sync with the number of internal error
  // codes.  If you get a CIT error about this, update the following line as
  // directed by the CIT output:

  INTERNAL_ERROR_CODE_COUNT =
      188, // <-- Update this number when adding new internal error codes

  FIRST_INTERNAL_ERROR_CODE_MINUS_ONE =
      (int)FABRIC_E_LAST_RESERVED_HRESULT - INTERNAL_ERROR_CODE_COUNT,

  //
  // Add new internal error codes for the current release only between the
  // [Start ...] and [End ...] tags below.
  //
  // New internal error codes should always be added above existing internal
  ...
  //
  // The file 'scripts\ErrorCodeValue.baseline' needs to be updated at the end
  // of each release to set the new threshold for internal error code changes.
  ...
  StaleRequest,
  // 'AbandonedFileWriteLockFound' has been replaced with public error code
  // CorruptedImageStoreObjectFound. This is kept so that backward compatibility
  // is not broken.
