...
CompletedAsyncOperation::CompletedAsyncOperation(
    ErrorCode const &error, AsyncCallback const &callback,
    AsyncOperationSPtr const &parent)
    : AsyncOperation(callback, parent), completionError_(error) {}

CompletedAsyncOperation::CompletedAsyncOperation(
    AsyncCallback const &callback, AsyncOperationSPtr const &parent)
    : AsyncOperation(callback, parent), completionError_(ErrorCode()) {}
...
ErrorCode
CompletedAsyncOperation::End(AsyncOperationSPtr const &asyncOperation) {
